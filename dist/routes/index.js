...
const middlewares_1 = require("../controller/middlewares");
const controllerDir = '../controller/src';
const authentication = middlewares_1.middlewares.authentication;
const hooks = middlewares_1.middlewares.hooks;
class Router {
